...
@pytest.mark.usefixtures("_health_success", "_localnet_up_to_date", "_list_running_localnet")
...
@pytest.mark.usefixtures("proc_mock", "_localnet_up_to_date", "_list_running_localnet")
...
@pytest.mark.usefixtures("_localnet_up_to_date", "_list_running_localnet")
...
@pytest.mark.usefixtures("app_dir_mock", "_list_running_localnet")
...
@pytest.mark.usefixtures("proc_mock", "_health_success", "_localnet_out_of_date", "_list_running_localnet")
...
@pytest.mark.usefixtures("proc_mock", "_health_success", "_localnet_img_check_cmd_error", "_list_running_localnet")
