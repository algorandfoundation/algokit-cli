...
2. Install pre-requisites:
   ...
   - Manually:
     - Install `Python` - [Link](https://www.python.org/downloads/): The minimum required version is `3.11`. It is also recommended to use `3.11` for development so dependencies on higher versions are not introduced, and to avoid debugging issues with `3.11`(see <https://github.com/fabioz/PyDev.Debugger/issues/234> and <https://github.com/microsoft/debugpy/issues/939>)
